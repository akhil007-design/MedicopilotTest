...
public class ScriptRunner {
	...
	{
		String user="appapollo";
		String password="dna";
		String database="ECG_Automation";
		String script="E:\\Workspace\\ECGManagerAuto\\Workbook\\HW\\TestData.sql";
		
		Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
		String dbURL = "jdbc:sqlserver://LXI264:1433;DatabaseName="+database;
